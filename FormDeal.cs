    ...
    public partial class FormDeal : Form
    {
        ...
        void ShowSupply()
        {
            ...
            foreach (SupplySet supplySet in Program.wftDb.SupplySet)
            {
                string[] item =
                {
                    ...
                    "Pиелтор: "+ supplySet.AgentsSet.SurName,
                    "Kлиент: "+supplySet.ClientsSet.SurName
                };
        ...
        void ShowDemand()
        {
            ...
            foreach (DemandSet demandSet in Program.wftDb.DemandSet)
            {
                ...
                demandSet.Id.ToString()+". ",
                 "Pиелтор: " + demandSet.AgentsSet.SurName,
                 "Kлиент: " + demandSet.ClientsSet.SurName
                };
        ...
        void ShowDealSet()
        {
            ...
            foreach (DealSet deal in Program.wftDb.DealSet)
            {
                ...
                {
                    deal.SupplySet.ClientsSet.SurName,
                    deal.SupplySet.AgentsSet.SurName,
                    deal.DemandSet.ClientsSet.SurName,
                    deal.DemandSet.AgentsSet.SurName,
